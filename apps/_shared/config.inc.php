...
$EXTENSION_PACKAGE['Illustrazioni']        = '_img'; // 0
$EXTENSION_PACKAGE['Paratesti']            = '_ptx'; // 1
$EXTENSION_PACKAGE['Testo']                = '_txt'; // 2
$EXTENSION_PACKAGE['Galleria di immagini'] = '_gal'; // 3
$EXTENSION_PACKAGE['Scheda di testo']      = '_txr'; // 4
$EXTENSION_PACKAGE['Citazioni']            = '_cit'; // 5
$EXTENSION_PACKAGE['Capolettera']          = '_cpl'; // 6
...
$PACKAGE_FIELDS['type'][$item] = 'list';
$item = 'source_commissioner';
$PACKAGE_FIELDS['label'][$item] = 'Fonte: Committenza';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'source_location';
$PACKAGE_FIELDS['label'][$item] = 'Fonte: Collocazione';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'source_provenance';
$PACKAGE_FIELDS['label'][$item] = 'Fonte: Provenienza';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'source_idno';
$PACKAGE_FIELDS['label'][$item] = 'Fonte: Segnatura, Codice';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'source_note';
...
$PACKAGE_FIELDS['type'][$item] = 'list';
$item = 'reference_commissioner';
$PACKAGE_FIELDS['label'][$item] = 'Originale: Committenza';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'reference_location';
$PACKAGE_FIELDS['label'][$item] = 'Originale: Collocazione';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'reference_provenance';
$PACKAGE_FIELDS['label'][$item] = 'Originale: Provenienza';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'reference_idno';
$PACKAGE_FIELDS['label'][$item] = 'Originale: Segnatura, Codice';
$PACKAGE_FIELDS['type'][$item] = 'string';
$item = 'reference_note';
